...
const Home: React.FC = () => {
  ...
  return (
    <main className="flex flex-col overflow-y-auto bg-slate-900">
      <div className="h-screen bg-background flex flex-col overflow-hidden">
        <Header />

        <main className="flex-1 pt-14 pb-[102px] flex overflow-hidden">
          ...
          <div className="w-96 shrink-0 border-l border-primary/10">
